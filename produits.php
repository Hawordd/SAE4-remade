    ...
    <div class="container">
            ...
            <div class="contenuBarre">
                ...
                <center>
                    ...
                    <form action="insert_products.php" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" pattern="[A-Za-z0-9 ]{0,100}" name="nomProduit"
        ...
        <div class="rightColumn">
            ...
            <div class="gallery-container">
                ...
                while ($i<count($returnQueryGetProducts)){ $Id_Produit=$returnQueryGetProducts[$i]["Id_Produit"];
                    ...
                    $Nom_Unite_Stock=$returnQueryGetProducts[$i]["Nom_Unite_Stock"]; if ($QteProduit>0){
                    echo '<style>
                    ';
echo 'form { display: inline-block; margin-right: 1px; }'; // Ajustez la marge selon vos besoins
                    ...
                    echo '<div class="square1">';
                        ...
                        echo '<img class="img-produit" src="img_produit/' . $Id_Produit  . '.png"
                            alt="'.$htmlImageNonFournie.'" style="width: 85%; height: 70%;"><br>';
