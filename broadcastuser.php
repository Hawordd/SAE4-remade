...
// Include language file - changed to language_fr.php as requested
...
<body class="d-flex" style="background-color: #EBF4EC;">
    ...
    <div class="flex-grow-1">
        ...
        <main class="p-3">
            <div class="container">
                <h1 class="my-3"><?php echo $htmlDiffusionUtilisateurs; ?></h1>

                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0"><?php echo $htmlEnvoiMessageUtilisateurs; ?></h5>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="traitements/traitement_broadcast_user.php" method="post"
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-success">
                                            <?php echo $htmlEnvoyerMessageATousUti; ?>
                                        </button>
                                    </div>
                                </form>
                        ...
                        <?php
                        // Get count of users for information
                        $bdd = dbConnect();
                        $queryUserCount = $bdd->query('SELECT COUNT(*) as count FROM UTILISATEUR WHERE Actif_Uti = 1');
                        $userCount = $queryUserCount->fetch(PDO::FETCH_ASSOC)['count'];
                        ?>

                        <div class="alert alert-info mt-4">
                            <i class="bi bi-info-circle me-2"></i>
                            <?php echo $htmlMessageEnvoyeA . ' ' . $userCount . ' ' . $htmlUtilisateurs; ?>
                        </div>
                    </div>
                </div>
            </div>
